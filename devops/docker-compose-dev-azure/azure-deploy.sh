...
resourcename="sportstatisticstracker"  # lower case, only
resourcegroup="sportstatisticstracker_rg"
...
# git clone https://github.com/apilogicserver/sportstatisticstracker.git
# cd sportstatisticstracker
...
az group create --name sportstatisticstracker_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group sportstatisticstracker_rg --sku S1 --is-linux
az container create --resource-group sportstatisticstracker_rg --name sportstatisticstracker --image apilogicserver/sportstatisticstracker:latest --dns-name-label sportstatisticstracker --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//sportstatisticstracker.westus.azurecontainer.io:5656'
